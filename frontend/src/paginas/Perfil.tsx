...
export default function Perfil() {
  ...
  const [dados, setDados] = useState<PerfilDados>({
    ...
    bairro: '', filhos: 0, idades_filhos: '', turno_disponivel: '', interesses: '',
    sobre_mim: '', experiencias: '[]', cursos: '[]', habilidades: '[]'
  });
        ...
        {!editando ? (
          <div className="pf-container-linkedin">
            ...
            <div className="pf-card-linkedin header">
              <button className="btn-secundario pf-btn-editar" onClick={iniciarEdicao}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                Editar Perfil
              </button>
              <div className="pf-header-top">
                <div className="pf-foto-perfil">{iniciais}</div>
            ...
            {/* Card 5: Experiências e Trabalhos */}
            <div className="pf-card-linkedin">
